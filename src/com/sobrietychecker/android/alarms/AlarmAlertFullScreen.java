...
import com.sobrietychecker.android.CheckinActivity;
import com.sobrietychecker.android.R;
...
public class AlarmAlertFullScreen extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // Register to get the alarm killed/snooze/acknowledge intent.
    ...
    private void updateLayout() {
        ...
        /* acknowledge button: close notification */
        findViewById(R.id.acknowledge).setOnClickListener(
    ...
    private void acknowledge(boolean killed) {
        Log.i(killed ? "Alarm killed" : "Alarm acknowledged by user");
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            // Volume keys and camera keys acknowledge the alarm
