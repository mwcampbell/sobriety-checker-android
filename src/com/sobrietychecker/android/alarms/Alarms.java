/*
 * Derived from the AOSP (Gingerbread) DeskClock app
...
package com.sobrietychecker.android.alarms;
...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.sobrietychecker.android.ALARM_ALERT";

    // A public action sent by AlarmKlaxon when the alarm has stopped sounding
    // for any reason (e.g. because it has been acknowledged from AlarmAlertFullScreen,
    // or killed due to an incoming phone call, etc).
    public static final String ALARM_DONE_ACTION = "com.sobrietychecker.android.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.sobrietychecker.android.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can acknowledge the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.sobrietychecker.android.ALARM_DISMISS";
